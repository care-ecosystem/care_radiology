...
create table patient_id (pk bigint not null, pat_id varchar(255) not null, pat_id_type_code varchar(255), entity_id varchar(255) not null, pat_name varchar(255) not null, entity_uid varchar(255) not null, entity_uid_type varchar(255) not null, version bigint, patient_fk bigint not null, primary key (pk), unique (pat_id, entity_id, entity_uid, entity_uid_type, pat_name));
